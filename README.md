...
![Screenshot](https://raw.githubusercontent.com/KartikeyaM2007/daedalOS/refs/heads/main/public/screenshot.png?raw=true)
...
- If during `yarn install` you receive the error `digital envelope routines::unsupported`, you need to set `NODE_OPTIONS` to `--openssl-legacy-provider` ([1](https://github.com/KartikeyaM2007/daedalOS/blob/main/Dockerfile#L3), [2](https://github.com/KartikeyaM2007/daedalOS/blob/main/.github/workflows/main.yml#L17), [3](https://stackoverflow.com/a/69699772/5895982))
