    ...
    async (
      ...
      try {
        ...
        switch (lcBaseCommand) {
          ...
          case "whoami":
            printLn("Kartikeya Krishna Mishra");
            printLn("Software Developer | AI & Deep Learning Enthusiast");
            printLn("Location: New Delhi, India");
            printLn("Email: kartikeyamishra2134@gmail.com");
            printLn("LinkedIn: linkedin.com/in/kartikeya-mishra-a92227191/");
            printLn("GitHub: github.com/KartikeyaM2007");
            break;
          case "experience":
            printLn("EXPERIENCE:");
            printLn("--------------------------------------------------");
            printLn("Machine Learning Intern @ Tech Octanet Services Pvt Ltd (Nov 2024 - Dec 2024)");
            printLn("- Developed machine learning models (Decision Trees, Random Forests, XGBoost).");
            printLn("- Preprocessed large datasets using Pandas & NumPy, improving accuracy by 15%.");
            printLn("");
            printLn("Data Science Intern @ TechnoHacks EduTech (Sept 2023 - Oct 2023)");
            printLn("- Assisted in developing predictive models using Scikit-Learn.");
            break;
          case "projects":
            printLn("PROJECTS:");
            printLn("--------------------------------------------------");
            printLn("1. Anomaly Detection Vision Transformer");
            printLn("2. Federated Hospital System");
            printLn("3. HiringSpree AI Agentic Resume Screening System");
            printLn("4. GetFlowDone AI Agent Builder");
            break;
          case "skills":
            printLn("SKILLS:");
            printLn("--------------------------------------------------");
            printLn("Languages: Python, JavaScript, TypeScript, C++, SQL");
            printLn("Frameworks: React, Next.js, Flask, Node.js");
            printLn("Libraries: PyTorch, Pandas, NumPy, Tailwind CSS");
            break;
          case "education":
            printLn("EDUCATION:");
            printLn("--------------------------------------------------");
            printLn("B.Tech in Computer Science and Engineering");
            printLn("Maharaja Surajmal Institute of Technology (2023 - 2027) | CGPA: 8.5");
            break;
          case "wsl":
          case "linux":
